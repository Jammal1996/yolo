...
from utilities import arg_parse_images
...
from utilities import preprocess_image, write_results_images, load_classes, draw_boxes
...
for i, batch in enumerate(imgs_batch):
    ...
    prediction = write_results_images(prediction, confidence, num_classes, nms_conf=nms_thesh)
    end = time.time()
